...
// console.log(game1[8])
// console.log(game1[game1.length - 1])
let game2 = "Assassin's Creed";

let game3 = `Final Fantasy`; // back tick

// console.log(game3.charAt(0))
// console.log(game3.at(0))

let temp_res = "games are = " + game1 + ", " + game2 + ", " + game3;
